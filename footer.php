<footer>
        <div class="container">
            <div class="area-social">
                ...
                <div class="social-media">
                    <span>Acompanhe as redes</span>
                    <ul>
                        <li>
                            <a href="" target="_blank">
                                <img src="<?php echo get_template_directory_uri() ?>/img/youtube.svg" alt="logo do youtube">
                            </a>
                        </li>
                        <li>
                            <a href="" target="_blank">
                                <img src="<?php echo get_template_directory_uri() ?>/img/linkedin.svg" alt="logo do linkedin">
                            </a>
                        </li>
                        <li>
                            <a href="" target="_blank">
                                <img src="<?php echo get_template_directory_uri() ?>/img/facebook.svg" alt="logo do facebook">
                            </a>
                        </li>
                        <li>
                            <a href="" target="_blank">
                                <img src="<?php echo get_template_directory_uri() ?>/img/instagram.svg" alt="logo do instagram">
                            </a>
                        </li>
                        <li>
                            <a href="" target="_blank">
                                <img src="<?php echo get_template_directory_uri() ?>/img/twitter.svg" alt="logo do twitter">
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="main-area">
                <div class="left">
                    ...
                    <div class="item">
                        <h5>Institucional</h5>
                        <ul>
                            <li><a href="#">Conheça a Bankboost</a></li>
            ...
            <div class="copy">
                <div class="text">
                    <img src="<?php echo get_template_directory_uri() ?>/img/emoticon.png" alt="">
    ...
    <script src="<?php echo get_template_directory_uri(); ?>/js/scrpits.js"></script>
